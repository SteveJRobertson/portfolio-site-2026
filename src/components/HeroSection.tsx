...
const socialLinks = [
  ...
  { icon: Globe, href: "https://steverobertson.dev/", label: "Website" },
      ...
      <div className="container relative z-10 py-20 md:py-32">
        ...
        >
          ...
          <p className="text-base md:text-lg text-muted-foreground/80 max-w-2xl mb-10 leading-relaxed">
            Over fifteen years building for the web, specialising in React,
            TypeScript, and design systems. I lead cross-team frontend
            initiatives — from shared UI libraries to large-scale codebase
            migrations.
          </p>
